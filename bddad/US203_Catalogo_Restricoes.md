...
| DOMAIN          | CKTIPOCULTURA                                               | CULTURAS                            | TIPOCULTURA              |
| DOMAIN          | CKOBJETIVOCULTURA                                           | CULTURAS                            | OBJETIVOCULTURA          |
...
| DOMAIN          | CKTIPOREGA                                                  | APLICACAOREGAS                      | TIPOREGA                 |
...
| REFERENTIAL     | FK_ENTREGAS_CODENTREGA                                      | ENTREGAS                            | CODMORADA                |
...
| KEY             | PK_CODCOLHEITA_CODCULTURA                                   | COLHEITAS_CULTURAS                  | CODCOLHEITA              |
...
| ENTITY          | NNVALORTOTAL                                                | COLHEITAS_CULTURAS                  | VALORTOTAL               |
| REFERENTIAL     | FK_SETORESAGRICOLAS_CULTURAS_CODSETORAGRICOLA               | SETORESAGRICOLAS_CULTURAS           | CODSETORAGRICOLA         |
| KEY             | SETORESAGRICOLAS_CULTURAS_PK                                | SETORESAGRICOLAS_CULTURAS           | CODSETORAGRICOLA         |
| REFERENTIAL     | FK_SETORESAGRICOLAS_CULTURAS_CODCULTURA                     | SETORESAGRICOLAS_CULTURAS           | CODCULTURA               |
| KEY             | SETORESAGRICOLAS_CULTURAS_PK                                | SETORESAGRICOLAS_CULTURAS           | CODCULTURA               |
| ENTITY          | NNDATAPLANTACAO                                             | SETORESAGRICOLAS_CULTURAS           | DATAPLANTACAO            |
| KEY             | SETORESAGRICOLAS_CULTURAS_PK                                | SETORESAGRICOLAS_CULTURAS           | DATAPLANTACAO            |
