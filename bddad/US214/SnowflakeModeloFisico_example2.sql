...
alter table Produções add constraint fk_Producoes_codTempo FOREIGN KEY (codTempo) references Tempo (codTempo);
alter table Vendas add constraint fk_Vendas_codProduto FOREIGN KEY (codProduto) references Produto (codProduto);
alter table Produções add constraint fk_Producoes_codProduto FOREIGN KEY (codProduto) references Produto (codProduto);
alter table Produções add constraint fk_Producoes_codSetorAgricola FOREIGN KEY (codSetorAgricola) references SetorAgricola (codSetorAgricola);
